    ...
    <div id="About" class="bg-white min-h-screen border-t-2 border-gray-500">
      <div class="container px-5 py-24 mx-auto">
        <div class="mb-24">
          ...
          <p class="text-gray-700 text-lg leading-relaxed mt-4">
              Join us in creating a tapestry of love and laughter that stretches across the diverse landscape of pet ownership. Welcome to a community that understands the language of paws, feathers, and fins—Plenty of Pets, where every pet has a story, and every owner has a friend.
          </p>
        </div>
      </div>
    </div>
