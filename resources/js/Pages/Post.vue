...
<script setup>
  ...
  import DynamicPostSocial from "../Components/DynamicPostSocial.vue";
  import DynamicPostRescue from "../Components/DynamicPostRescue.vue";
  import DynamicPostInteractive from "../Components/DynamicPostInteractive.vue";
